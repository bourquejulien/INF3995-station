...
export class FirmwareService {
    ...
    flashFile(file: File): Observable<string> {
        ...
        return this.httpClient.post(`${environment.serverURL}/firmware/flash`, formData, { responseType: "text" }).pipe(catchError(this.handleError));
    }
    ...
    getFile(path: string): Observable<string> {
        ...
        return this.httpClient
            .get(`${environment.serverURL}/firmware/get_file`, { params: queryParams, responseType: "text" })
            .pipe(catchError(this.handleError));
    }
