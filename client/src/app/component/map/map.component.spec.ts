...
describe("MapComponent", () => {
    ...
    beforeEach(async () => {
        mockCommandService = jasmine.createSpyObj(
            "CommandService",
            { getUris: Promise.resolve(), retrieveMode: Promise.resolve() },
            { urisObservable: new Subject<[string, boolean][]>().asObservable() },
        );
    ...
    beforeEach(() => {
        ...
        positionsCtxSpy = jasmine.createSpyObj("CanvasRendringContext", [
            "beginPath",
            "closePath",
            "fillRect",
            "fill",
