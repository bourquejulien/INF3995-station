...
def test_get_file(client, app, mocker):
    ...
    with app.container.firmware_service.override(firmware_service_mock):
        response = client.get(url_for("firmware.get_file"), query_string={"path": "test"})
...
def test_edit(client, app, mocker):
    ...
    with app.container.firmware_service.override(firmware_service_mock):
        response = client.post(url_for("firmware.edit"), query_string={"path": "test"}, data="test")
...
def test_flash(client, app, mocker):
    ...
    with app.container.firmware_service.override(firmware_service_mock):
        response = client.post(url_for("firmware.flash"), data=data, content_type="multipart/form-data")
