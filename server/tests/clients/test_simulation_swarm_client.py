...
from src.clients.simulation_swarm_client import SimulationSwarmClient, distance_to_position
...
def test_distance_to_position(app, mocker):
    ...
    assert result == [Position(1, 1.99, 0), Position(1, 2.02, 0), Position(1.03, 2, 0), Position(0.96, 2, 0)]
